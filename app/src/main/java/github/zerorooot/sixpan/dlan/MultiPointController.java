package github.zerorooot.sixpan.dlan;
...
public class MultiPointController implements IController {
    ...
    public void play(final Device device, final String path) {
        ...
        if (playerMonitor != null) {
            HANDLER.post(() -> playerMonitor.onPreparing());
        }
        executor.execute(() -> {
        ...
        executor.execute(() -> {
            ...
            if (playerMonitor != null) {
                HANDLER.post(() -> {
                    ...
                    playerMonitor.onGetMaxVolume(Integer.parseInt(value));
                });
            }
        });
    }
    ...
    private int format(String timeStr) {
        ...
        return 3600 * Integer.parseInt(values[0]) + 60 * Integer.parseInt(values[1]) + Integer.parseInt(values[2]);
    }
